...
@Mod("sao_mod")
public class SaoModMod {
	public static final Logger LOGGER = LogManager.getLogger(SaoModMod.class);
	public static final String MODID = "sao_mod";
