...
public class SwordInventoryMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public SwordInventoryMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(SaoModModMenus.SWORD_INVENTORY, id);
