...
public class SwordArtInventoryButtonMessage {
	...
	public SwordArtInventoryButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(SwordArtInventoryButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(SwordArtInventoryButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
